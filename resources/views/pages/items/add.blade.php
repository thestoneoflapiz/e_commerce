        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h4 class="card-title"> Add an Item</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Ex: My Bag | BRANDED!" class="form-control" name="name">
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-4">
                                <div class="form-group">
                                    <label>Image <span class="required">*</span></label>
                                    <input type="text" placeholder="Ex: https://google.com/my-image" class="form-control" name="image">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Ex: 1500" class="form-control" name="price">
                                </div>
                            </div>
                        </div>
